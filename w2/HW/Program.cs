...
/// <summary>
/// The Project class is responsible for managing the grading process for a group of students. It allows the user to enter student names, lab grades, and calculates the average lab grade and letter grade for each student.
/// </summary>
namespace week2Lab
{
    class Project
